```
rails g model Message source_user_id:integer target_user_id:integer message_content:string
...
```
rails g controller api/v1/Messages
```
...
<script type="text/javascript">
    ...
    function updateContact(userId, userName, avatarURL) {
    ...
    function fetchContactList() {
        fetch('api/v1/contacts/<%= Current.user.id %>')
            ...
            .then(function (data) {
                ...
                data.map(contact => updateContact(contact.contact_id, contact.user_name, contact.avatar_url));
    ...
    window.onload = function() {
        ...
        setInterval(refreshContactList, 20000);
    };
</script>
```